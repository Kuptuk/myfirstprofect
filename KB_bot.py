      ...
      try:
          ...
          if 608994688078184478 in b and list(message.message.content)[-1] != '-':
            if randch == 1:
              ...
              response = Image.open(io.BytesIO(requests.get('https://media.discordapp.net/attachments/689800301468713106/807930561539997706/card_leo.png', stream = True).content))
              idraw = ImageDraw.Draw(response)
            else:
