    ...
    if id == 'badges':
      ...
      try:
          ...
          if str(member.id) in souz.content:
            prioritet += 1
            allia = Image.open(io.BytesIO(requests.get('https://media.discordapp.net/attachments/689800301468713106/806274967808245900/review.png', stream = True).content)).convert('RGBA')
