...
async def upd(message):
  ...
  embed.add_field(name='12.08.2020',value='🔄 Глобальное изменение `K.server` совместно с <@614830303831261253> ;3',inline=False)
  embed.add_field(name='16.08.2020',value='🛠️ Создание команды `K.problem`, которая позволяет задавать вопросы администрации сервера.',inline=False)
